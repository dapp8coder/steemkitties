## Contributing to SteemKitties

Want to get involved in SteemKitties developement? Thanks! There are plenty of ways you can help!
...
The [issue tracker](https://github.com/sdavignon/steemkitties/issues) is the preferred channel

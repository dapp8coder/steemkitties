  ...
  plugins: [
    new webpack.DefinePlugin({
      'process.env': {
        ...
        STEEMCONNECT_CLIENT_ID: JSON.stringify(process.env.STEEMCONNECT_CLIENT_ID || 'steemkitties'),
        STEEMCONNECT_REDIRECT_URL: JSON.stringify(
          process.env.STEEMCONNECT_REDIRECT_URL || 'https://steemkitties.herokuapp.com/callback',
        ),
